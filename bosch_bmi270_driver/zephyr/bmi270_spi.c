...
LOG_MODULE_DECLARE(bmi270, CONFIG_LOG_DEFAULT_LEVEL);
...
static int bmi270_reg_read_spi(const union bmi270_bus *bus, uint8_t start,
...
static int bmi270_bus_init_spi(const union bmi270_bus *bus)
{
	...
	/*  the initial dummy read configures it to SPI. (Datasheet Page.17)*/
